...
<!-- docref: begin src=packages/vscode/src/logic.ts#diagnosticsFromReport:f7d534c7,packages/vscode/src/logic.ts#quickFixesForState:247f87a2 -->
...
- **Collection sidebar:** add the current selection to a chosen
  ...
  directly.
<!-- docref: begin src=packages/vscode/src/logic.ts#statusText:1abf4e83 -->
